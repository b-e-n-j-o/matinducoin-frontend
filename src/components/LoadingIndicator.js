      ...
      <div className="bottle-fade-out">
        <svg xmlns="http://www.w3.org/2000/svg" width="275" height="325" viewBox="0 0 200 800">
          <defs>
            ...
            <path id="bottle" d="M 250 138 q -0.5 4 -1 8 H 237 q 0.5 22 1 44 c 10.525 39.283 50.368 54.842 62 97 L 302 520 c 0 37.184 5.581 157.282 -7 174 c -6 7.975 -17.65 15.633 -29 18 H 87 c -15.57 -3.053 -27.538 -12.982 -33 -26 c -3.823 -9.111 -1.093 -19.85 -3 -32 V 456 l 2 -161 c 10.305 -49.593 45.54 -57.677 60 -92 c 6.463 -15.342 6.02 -36.015 6 -58 H 105 v -7 c 6.191 0.491 10.77 0.928 13 -3 h -6 V 61 l 3 -1 c 10.017 -6.186 120.05 -2.956 128 2 v 73 c -5.223 0.419 -3.984 -0.656 -6 3 h 13 Z"/>
            <mask id="bottle_mask">
